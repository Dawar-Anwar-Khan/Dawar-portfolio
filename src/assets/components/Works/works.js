export default [
    ...
    {
        title: "Close to the world",
        context: "An interactive and responsive web app that allows users to explore detailed information about countries around the world. Built with HTML, CSS, and ReactJS, the app fetches real-time data from the REST Countries API and displays it in a clean card-based UI.",
        link:"https://close-to-the-world-app.netlify.app/",
        code:""
    },
    {
    ...
    {
        title: "Pure Tunes",
        context: "A visually engaging and responsive music streaming app interface built with VanillaJS and HTML, CSS. PureTunes mimics the look and feel of modern music platforms, providing a smooth user experience with clean layouts, rich visuals, and interactive elements.",
        link:"https://puretunes.netlify.app",
        code:""
    },
]