  ...
  return (
    <section className='py-8'>
      <div className='mx-auto w-1/2 pt-36 flex flex-col justify-center items-center text-center'>
        ...
        <p className='text-xl text-blue-100 mb-6'> Frontend Developer | BCA Student @ <a className='underline' href="https://www.jbcollege.in/">JBKP</a></p>
        ...
        <div className='space-x-7'>
          ...
          <a className='  font-bold text-gray-400 hover:text-white' href="https://github.com/Dawar-Anwar-Khan">Github</a>
          <a className='text-gray-400 font-bold hover:text-white' href="https://www.linkedin.com/in/dawar-anwar-khan-50458633a/">LinkedIn</a>
        </div>
    </div>
    </section>
  )
